...
<div class="details_div_first">
    ...
    <div class="frm_div_last warn_height">
        ...
        <label class="frm_label text_info" id="lbl_product_isEnabled_true" for="radio_product_isEnabled_true">normal</label>
        <input id="radio_product_isEnabled_false" name="radio_product_isEnabled" type="radio" value="1">
        <label class="frm_label text_info" id="lbl_product_isEnabled_false" for="radio_product_isEnabled_false">Out of sale</label>
...
<div class="details_div">
    ...
    <div class="frm_div">
        <label class="frm_label text_info" id="lbl_product_id">product number</label>
        <span class="details_value" id="span_product_id">system specified</span>
        <label class="frm_label text_info" id="lbl_product_create_date">listing date</label>
    ...
    <div class="frm_div_last">
        <label class="frm_label text_info" id="lbl_product_price" for="input_product_price">original price of the product</label>
        ...
        <label class="frm_label text_info" id="lbl_product_sale_price" for="input_product_sale_price">promotional price of the product</label>
...
<div class="details_div">
    <span class="details_title text_info">overview picture</span>
...
<div class="details_div">
    <span class="details_title text_info">detail image</span>
...
<div class="details_div details_div_last details_property_list" >
    <span class="details_title text_info">attribute value information</span>
...
<div class="modal fade" id="modalDiv" tabindex="-1" role="dialog" aria-labelledby="modalDiv" aria-hidden="true" data-backdrop="static">
    <div class="modal-dialog">
        <div class="modal-content">
            ...
            <div class="modal-body">Are you sure you want to delete that product image?？</div>
