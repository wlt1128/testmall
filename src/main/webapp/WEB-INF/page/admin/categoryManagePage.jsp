...
<div class="frm_div text_info">
    <div class="frm_group">
        <label class="frm_label" id="lbl_category_name" for="input_category_name">Classification name</label>
        <input class="frm_input" id="input_category_name" type="text" maxlength="50"/>
        <input class="frm_btn" id="btn_category_submit" type="button" value="inquire"/>
        <input class="frm_btn frm_clear" id="btn_clear" type="button" value="reset"/>
    </div>
    <div class="frm_group_last">
        <input class="frm_btn frm_add" id="btn_category_add" type="button" value="add a category" onclick="getChildPage(null)"/>
    </div>
</div>
    ...
    <table class="table_normal" id="table_category_list">
        ...
        <c:forEach items="${requestScope.categoryList}" var="category">
            <tr>
                ...
                <td><span class="td_special" title="view category details"><a href="javascript:void(0)"
